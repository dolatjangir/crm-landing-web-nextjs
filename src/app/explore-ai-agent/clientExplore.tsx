  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50 pt-12 pb-4 lg:pt-20">
...
function AgentCard({ 
  ...
  return (
    ...
    >
      ...
      {/* Hover CTA */}
      <div className={`absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-blue-500 via-blue-300 to-transparent transform transition-transform duration-300 ${isHovered ? 'translate-y-0' : 'translate-y-full'}`}>
        <div className="flex items-center justify-center gap-2 text-[#062553] font-semibold text-sm">
          Learn More
