    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        <p className="mt-6 max-w-3xl mx-auto text-gray-600 text-lg sm:text-xl leading-relaxed">
          Deploy intelligent AI agents that handle lead qualification, property matching, content creation, calling, follow-ups, campaigns, data mining, and SEO — all working 24/7 to grow your business.
        </p>
