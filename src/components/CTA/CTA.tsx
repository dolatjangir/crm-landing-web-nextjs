...
export default function CTA() {
  return (
    <section
      id="get-started"
      className="relative bg-gradient-to-br from-cyan-950 via-cyan-800 to-cyan-900 py-10 sm:py-16 text-center overflow-hidden"
    >
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          Stop Manual CRM Work.{" "}
          <span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
            Let AI Agents Take Over.
          </span>
        </h2>
        ...
        >
          Join 500+ businesses that replaced tedious CRM tasks with intelligent AI agents. 
          From lead qualification and property matching to content creation and follow-ups — 
          your agents work 24/7 so you can focus on closing deals, not managing data.
        </p>
        ...
        >
          ...
          >
            <span>Deploy AI Agents Free</span>
        ...
        >
          <p className="text-gray-300 text-sm mb-6">Trusted by 500+ businesses automating with AI</p>
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            <div className="text-white/40 font-semibold text-lg">Real Estate</div>
            <div className="text-white/40 font-semibold text-lg">Consultancy</div>
            <div className="text-white/40 font-semibold text-lg">Travel</div>
