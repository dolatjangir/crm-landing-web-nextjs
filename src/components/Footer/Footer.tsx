export default function Footer() {
  const subCRMs = [
    { name: "Property CRM", link: "https://property.ibigdata.in" },
    { name: "Consult CRM", link: "https://consult.ibigdata.in" },
    { name: "Travel CRM", link: "https://travel.ibigdata.in" },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            ...
            <div className="mt-6 flex items-center gap-4">
              {social.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="p-2 rounded-lg bg-white border border-gray-200 text-gray-600 hover:text-cyan-600 hover:border-cyan-300 hover:shadow-md transition-all duration-200"
                  target="_blank"
          ...
          <div className="max-w-md">
            ...
            <div className="flex gap-2">
             {/*  <input
                ...
                className="flex-1 px-4 py-2 text-black rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-600 focus:border-transparent text-sm"
              /> */}
              <button className="px-6 py-2 rounded-lg bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-semibold text-sm hover:shadow-lg hover:shadow-cyan-600/30 transition-all duration-200 whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} ibigdata. All rights reserved.
          </p>
